...
class IoTMLAnalyzer:
    ...
    def train_energy_predictor(self):
        ...
        # Save model
        joblib.dump(self.energy_predictor, '/app/models/energy_predictor.pkl')
    ...
    def train_maintenance_predictor(self):
        ...
        # Save model
        joblib.dump(self.maintenance_predictor, '/app/models/maintenance_predictor.pkl')
    ...
    def predict_energy_consumption(self, hours_ahead=24):
        ...
        try:
            # Load model
            energy_predictor = joblib.load('/app/models/energy_predictor.pkl')
    ...
    def predict_maintenance_needs(self):
        ...
        try:
            # Load model
            maintenance_predictor = joblib.load('/app/models/maintenance_predictor.pkl')
