...
function App() {
  ...
  const fetchData = async () => {
    try {
      ...
      console.log(`✅ Data loaded: ${devices.length} devices, ${alerts.length} alerts, ${anomalies.length} anomalies (24h), ${maintenanceData.predictions?.length || 0} maintenance predictions`);
